...
2. **<font color=red face="PingFang SC">choose.html</font>**
	...
	3. **<font color=red face="PingFang SC">about.html</font>**
		...
		4. 因为我们是打算用PHP运行的环境,所以我们需要做些准备
			...
			![index.html](../assets/php-practiceProjects/1.png)
	
			![index.html](../assets/php-practiceProjects/2.png)
	
			![choose.html](../assets/php-practiceProjects/3.png)
	
			![about.html](../assets/php-practiceProjects/4.png)
	
		## 项目第二步,从HTML切换到PHP
	
		这一步算是很重要的一步,因为要让浏览器知道我们需要用上*php*,而不是*html*.
		
		![更改成PHP](../assets/php-practiceProjects/5.png)
		
		- 然后,我们需要对这三个PHP内容,进行**修改**,因为里面指向的链接有点问题,我们现在是*php*结尾的文件
		
			![](../assets/php-practiceProjects/6.png)
		
		- 然后呢,我们去到浏览器,查看我们对应的URL,能否正确跳转到我自己的定义是这样的,根据自己的实际情况进行更改`http://localhost/chooseApp/index.php`
		
			![](../assets/php-practiceProjects/7.png)
	...
	2. 首先,启动你的`XMAPP`,**这里你需要保证的是您的Apache和Mysql都是start状态**
		 ...
		 最少需要的两个![XMAPP](../assets/php-practiceProjects/8.png)
	...
	3. 然后把下面的做了
		...
		2. 再创建一个`dp.php`**文件**:这个是放在`config`这个文件夹下的,这个*php*定义了数据连接所需的信息,包括了**port**,**psw**等.<font color="red">**需要注意**:*我们这里是一个测试,不是生产环境,在生产环境,暴露psw可能造成不可预估的影响,是绝对禁止的*</font>
		 ...
		 ![如图所示](../assets/php-practiceProjects/9.png)
		...
		- 这里我把过程以图片发出来
			...
			![](../assets/php-practiceProjects/10.png)
		...
		- 然后创建一个新用户
			...
			![](../assets/php-practiceProjects/11.png)
		  ...
		  ```sql
			...
			![插入表的数据](../assets/php-practiceProjects/12.png)
		...
		4. ​	**更新db.php**
			...
			- 这里我打算补充一些我遇到的问题
				...
				**解决方法**:
				...
				1. 到这个文件夹下,找到`my.ini`![](../assets/php-practiceProjects/21.png)把所有的**`3306`**,修改一下端口,这个端口任意都行
		
				2. 然后去到任务管理器,**stop自己的原先的mysql服务**![](../assets/php-practiceProjects/22.png)
			
				3. 再到这里`D:\XAMPP\phpMyAdmin`这个文件![](../assets/php-practiceProjects/23.png)
			...
			- **检查连接**:通过检查`$conn->connect_error`来确认是否连接到数据库
				...
				![成功图](../assets/php-practiceProjects/13.png)
			...
			5. 在`choose.php`引入我们的模拟数据
				...
				**<font color="red">这里的是我们模拟从数据库获取数据,生产环境下并不能这样做</font>**
				...
				![](../assets/php-practiceProjects/14.png)
				...
				![](../assets/php-practiceProjects/15.png)
			...
			*Error同理*
			...
			![](../assets/php-practiceProjects/16.png)
			...
			**这里新建一个`login.php`用于我们的登录验证,其实是为了避免代码太杂乱,方便我维护**
			...
			![](../assets/php-practiceProjects/17.png)
			...
			![](../assets/php-practiceProjects/18.png)
			
			![](../assets/php-practiceProjects/19.png)
			
			![](../assets/php-practiceProjects/20.png)
